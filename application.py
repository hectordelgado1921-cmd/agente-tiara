...
/* Mantener los botones rápidos en 2 columnas también en teléfonos.
   Streamlit puede apilarlos por debajo de ~640px; aquí conservamos el
   diseño de referencia 2 + 2 + 1 sin cambiar su funcionamiento. */
...
/* Micrófono: compacto para que quede realmente dentro del compositor.
   st.audio_input sigue siendo el control funcional; width=58 abajo evita
   que el grabador fuerce una segunda fila en móvil. */
...
/* La fila del compositor nunca se apila. */
.st-key-tiara_unified_composer div[data-testid="stHorizontalBlock"] {
    flex-wrap:nowrap !important;
    align-items:center !important;
    gap:10px !important;
}
.st-key-tiara_unified_composer div[data-testid="stHorizontalBlock"] > div {
    min-width:0 !important;
}
.st-key-tiara_unified_composer div[data-testid="stHorizontalBlock"] > div:first-child {
    flex:0 0 58px !important;
    width:58px !important;
}
.st-key-tiara_unified_composer div[data-testid="stHorizontalBlock"] > div:nth-child(2) {
    flex:1 1 auto !important;
    width:auto !important;
}
.st-key-tiara_unified_composer div[data-testid="stHorizontalBlock"] > div:last-child {
    flex:0 0 58px !important;
    width:58px !important;
}

/* El campo central debe verse como una sola pastilla, como en la referencia. */
.st-key-tiara_unified_composer [data-testid="stTextInput"] {
    margin:0 !important;
}
.st-key-tiara_unified_composer [data-testid="stTextInput"] > div > div {
    min-height:58px !important;
    height:58px !important;
...
.st-key-tiara_unified_composer [data-testid="stTextInput"] input {
    font-size:1rem !important;
    padding-left:16px !important;
    padding-right:12px !important;
}

/* Botón enviar circular, alineado con el micrófono. */
.st-key-tiara_unified_composer [data-testid="stFormSubmitButton"] button {
    width:58px !important;
    min-width:58px !important;
    height:58px !important;
    min-height:58px !important;
...
/* Ocultar textos/controles auxiliares del formulario */
[data-testid="stForm"] {
    background:transparent !important;
    border:0 !important;
    padding:0 !important;
...
@media (max-width: 700px) {
    ...
    .tiara-composer { border-radius:22px; }
}
</style>
...
# En móvil: 2 + 2 + 1, como en el diseño de referencia.
...
# ============================================================
# COMPOSITOR ÚNICO: TEXTO + VOZ + ENVÍO
# ============================================================
with st.form("tiara_unified_composer", clear_on_submit=True, border=False):
    st.markdown('<div class="tiara-composer">', unsafe_allow_html=True)
    c_voice, c_text, c_send = st.columns([1.15, 6.8, 1.25], vertical_alignment="center")
...
if send_question:
    ...
    if typed_question:
        ...
        audio_type = getattr(voice_audio, "type", None) or "audio/webm"
