...
def detect_intent(p):
    ...
    if any(x in p for x in ("ultimo cambio", "último cambio", "ultimo mantenimiento", "último mantenimiento", "cuando fue", "cuándo fue", "cuando se hizo", "cuándo se hizo", "cuando cambiaron", "cuándo cambiaron", "cuando se cambio", "cuándo se cambió", "ultima vez", "última vez")): return "ultimo_mantenimiento"
...
def answer_fuel(data, thought):
    ...
    # Combustible siempre se resuelve primero desde su propia hoja.
    # El presupuesto contiene un rubro financiero relacionado, pero no es la
    # fuente principal cuando el usuario pregunta por gasolina/combustible.
