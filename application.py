...
/* Audio recorder — mantiene el componente funcional y lo integra visualmente */
...
@media (max-width: 700px) {
    ...
    .tiara-header { margin-bottom:15px; }
    .tiara-boat { font-size:2.25rem; }
    .tiara-title { font-size:1.65rem; }
    .tiara-subtitle { font-size:.65rem; letter-spacing:.17em; }
    .tiara-menu { font-size:2.15rem; }
