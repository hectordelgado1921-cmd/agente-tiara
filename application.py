...
def _budget_sheet_records_direct(data):
    """Fuente exclusiva para SALIDAS BARCO y su cruce: hoja de presupuesto."""
...
def _salidas_barco_record(data):
    """Localiza exclusivamente la fila oficial SALIDAS BARCO del presupuesto."""
...
def run_agent(data, question, context=None):
    ...
    if thought.get("rubric") == "SALIDAS BARCO":
        ...
        if op in ("costo_combustible_por_salida", "comparacion"):
