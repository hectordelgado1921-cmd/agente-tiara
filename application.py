...
def _budget_name_matches(name, rubric):
    ...
    variants = {
        ...
        # En el Excel fuente el rubro aparece como "SALIDA BARCO"
        # (singular), mientras que el cerebro utiliza el nombre canónico
        # "SALIDAS BARCO". Ambas formas representan exactamente el
        # mismo rubro y deben apuntar a la misma fila del presupuesto.
        "salidas barco": {
            "salidas barco",
            "salida barco",
        },
