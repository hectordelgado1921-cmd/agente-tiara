...
def _is_semantic_continuation(p, context=None):
    ...
    if any(x in p for x in (
        ...
        return True
    if len(p.split()) <= 5 and any(x in p for x in (
        "cuando", "cuándo", "cuando toca", "cuándo toca", "cuanto", "cuánto",
        "qué falta", "que falta", "cuando fue", "cuándo fue",
        "que fue lo ultimo", "qué fue lo último", "cual vence primero", "cuál vence primero", "cuantas horas faltan", "cuántas horas faltan",
        "y los otros", "y las otras", "y el otro", "y la otra", "y después", "y despues", "el siguiente", "la siguiente", "y el siguiente", "y la siguiente", "y el anterior", "y la anterior", "que le hicieron", "qué le hicieron", "que hicieron", "qué hicieron", "cuando fue eso", "cuándo fue eso",
        "diferencia", "variacion", "variación", "cambio", "cuanto cambio", "cuánto cambió",
        "cual fue la diferencia", "cuál fue la diferencia", "qué toca", "que toca",
        "qué toca hacerle", "que toca hacerle"
    )):
        return True
    return False
