...
# ============================================================
# El resultado se muestra antes del compositor. El compositor queda fijo
# al final de la pantalla para que siempre esté disponible en el teléfono.
...
# Compositor: micrófono y enviar tienen el mismo tamaño y permanecen en una
# sola fila también en pantallas pequeñas.
...
# Ejecutar tanto consultas manuales como de voz con exactamente el mismo agente.
if quick:
    ...
    # Segunda pasada: ahora el resultado queda arriba del compositor fijo.
    st.rerun()
